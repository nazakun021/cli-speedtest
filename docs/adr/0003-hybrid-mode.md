...
The unbounded cooldown bypass described here is constrained by the later
[Quick Burst decision](0004-quick-mode-safety-limits.md): five successful Quick
Mode tests are allowed before the standard Cooldown applies.
